...
Page({
  ...
  onLoad: function (options) { 
    //console.log("current warehouse")
    if(app.globalData.currPro==="undefine"){
      this.setData({
        noPro:true
      })
    }
  ...
  bindUpdate:function(){
      ...
      wx.navigateTo({
        url: '../warehouse/material/material?id='+that.data.id+"&name="+that.data.name,
      })
      //console.log("跳转")
  },
  bindGroup:function(){
    ...
    wx.navigateTo({
      url: '../warehouse/group/group?id='+that.data.id+"&name="+that.data.name+"&introduction="+this.data.introduction+"&member="+member+"&creator="+this.data.creator+"&creatorOpenid="+this.data.creatorOpenid,
    })
    //console.log("跳转")
  },
  // 库存盘点
  bindInventory:function(){
    ...
    wx.navigateTo({
      url: '../warehouse/inventory/inventory?id='+that.data.id+"&name="+that.data.name+"&latestList="+material,
    })
    //console.log("跳转")
  },
  bindVerify:function(){
    ...
    //console.log("JSON",materialListTemp)
    var examiningTemp = JSON.stringify(that.data.examining)
    //console.log("JSON",examiningTemp)
    wx.navigateTo({
      url: '../warehouse/verify/verify?id='+that.data.id+"&name="+that.data.name+"&materialList="+materialListTemp+"&examiningTemp="+examiningTemp,
    })
    //console.log("跳转")
  },
  bindmsg:function(){
    ...
    wx.navigateTo({
      url: '../warehouse/tobe/tobe?id='+that.data.id+"&name="+that.data.name+"&examiningTemp="+examiningTemp+"&backIsUndefine="+this.data.backIsUndefine,
    })
    //console.log("跳转")
  },
