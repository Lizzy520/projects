...
Page({
  ...
  bindSave:function(){
    ...
    app.globalData.rowList1=that.data.rowList
    //console.log("离开前",app.globalData.rowList1)
    wx.showToast({ 
      title:"保存成功",  
      icon: 'success',  
      mask: true,  
  ...
  onLoad: function (options) {
    ...
    //console.log("rowList1",app.globalData.rowList1)
    var appRowList=app.globalData.rowList1;
    this.setData({
      id:options.id,
      // rowList:temp,
      rowList:appRowList
    ...
    //console.log("测试保留数据",app.globalData.rowList1)
